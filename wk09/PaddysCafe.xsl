                ...
                <table id="menuTable" border="1" class="indent">
                    ...
                    <tbody>
                        <xsl:for-each select="/cafemenu/section">
                            <tr>
                                <td colspan="3">
                                    <!-- select the name of section each -->
                            ...
                            <xsl:for-each select="entree">
                                <tr>
                                    <xsl:attribute name="vegetarian">
                                        <!-- check if each of the attribute vegetarian in an entree has value -->
                                    ...
                                    <td>
                                        <!-- @price won't be working since the field item in an entree has no atrribute -->
                                        <!-- <xsl:value-of select="@item" /> -->
                                        
                                        <!-- take the value in the field 'item' in each of the entree -->
                                        <xsl:value-of select="item" />
                                    </td>
                                    <td align="right">
                                        
                                        <!-- @price won't be working since the field price in an entree has no atrribute -->
                                        <!-- <xsl:value-of select="@price" /> -->

                                        <!-- take the value in the field 'price' in each of the entree -->
                                        <xsl:value-of select="price" />
                                    </td>
                                </tr>
                            </xsl:for-each>
